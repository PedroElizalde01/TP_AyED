...
public class Ejercicio2c {
    public static void main(String[] args) {
        ...
        System.out.println("El tiempo en milisegundos es de: " + bubbleTime + " milisegundos");
        currentTime= System.currentTimeMillis();
        Selection.selectionSort(arrayToSort);
        long selectionTime= (System.currentTimeMillis()- currentTime);
        System.out.println("El tiempo en milisegundos es de: " + selectionTime + " milisegundos");
        currentTime= System.currentTimeMillis();
        Insertion.insertionSort(arrayToSort);
        long insertionTime= (System.currentTimeMillis()- currentTime);
        System.out.println("El tiempo en milisegundos es de: " + insertionTime + " milisegundos");
